...
export default function Hero({ className }: HeroProps) {
  return (
    ...
    >
      <div className="items-center gap-x-12 sm:justify-between md:flex">
        <h2 className="flex items-start justify-center sm:justify-start">
          <svg
            className="-mt-3.5 -ml-1 scale-[.35] sm:-mt-3 sm:scale-[.55]"
            width="37"
            height="58"
            viewBox="0 0 37 58"
            fill="none"
          ...
          <span className="flex flex-col items-start gap-y-2 whitespace-nowrap font-grifter text-3xl font-extrabold text-white sm:text-5xl">
            <span>The gig economy</span>
            <span>for programmers</span>
          </span>
          <div className="-ml-1.5 flex flex-col items-center sm:-mt-1 sm:-ml-0.5">
            <svg
              className="-my-7 scale-[.35] sm:-my-5 sm:scale-[.55]"
              width="42"
              height="86"
              viewBox="0 0 42 86"
              fill="none"
        ...
        <p className="mt-12 leading-6 text-gray-300 md:-mt-3">
          Browse jobs, write code, and get paid instantly no matter where you
          are in the world
        </p>
      </div>
      <div className="mt-12 items-start gap-x-12 md:mt-24 md:flex">
        <EmailRegistration className="mt-8 flex-1 md:mt-0" />
