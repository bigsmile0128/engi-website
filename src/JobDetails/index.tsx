    ...
    <div className="max-w-7xl mx-auto p-8 sm:p-16 md:p-24 flex items-start gap-x-12">
      <div className="flex flex-col">
        <div className="flex items-center">
          ...
          <h1 className="font-grifter text-3xl -mb-2 px-4">
            Responsive website
          </h1>
        ...
        <div className="flex items-center mt-12 gap-x-4">
          <span className="flex items-center gap-x-2 border border-gray-500 py-2 px-4 bg-gradient-to-r from-[#ffffff11]">
        ...
        <p className="text-gray-400 mt-6">Posted 4 days ago</p>
        <div className="mt-6 mb-10 w-full border-t border-gray-400 opacity-50" />
        <h2 className="font-grifter text-2xl">Job Description</h2>
      ...
      <div className="basis-80 p-6 flex flex-col shrink-0 bg-[#00000022]">
        ...
        <span className="text-sm text-gray-400 mb-0">97 jobs posted</span>
