...
const Home: NextPage = () => {
  return (
    <div>
      ...
      <Hero className="md:max-w-2xl lg:max-w-4xl xl:max-w-6xl mx-auto px-4 sm:px-6 md:px-0" />
      <FigmaPreview className="mx-6 max-w-3xl lg:max-w-4xl xl:max-w-6xl mt-24" />
      {isDevEnv() && (
        <>
