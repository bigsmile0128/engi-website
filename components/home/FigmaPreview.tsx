...
export default function FigmaPreview({ className }: FigmaPreviewProps) {
  return (
    <div className={classNames('grid relative', className)}>
        ...
        <div className="md:p-20 lg:p-4 xl:p-12 md:block select-none">
          <div className="bg-[#00000022] border border-[#ffffff66] flex flex-col">
            ...
            <div className="p-4">
              ...
              <div className="flex flex-col items-center justify-center text-md xs:text-xl font-bold -mt-5 xs:-mt-6">
                <p>Well done!</p>
                <p>
                  It&rsquo;s the
      ...
      <div className="flex flex-col items-start mt-8 justify-self-end overflow-hidden sm:mr-8 md:mr-0 md:absolute md:bottom-0 md:left-1/2 lg:left-56 xl:left-1/4 md:translate-y-1/2 lg:translate-y-2/3 xl:translate-y-1/2">
